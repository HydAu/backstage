...
import * as DisclosureStories from '../../../packages/ui/src/components/Disclosure/Disclosure.stories';
...
export const DisclosureSnippet = createSnippetComponent(DisclosureStories);
